...
$from = "muchousei36@gmail.com";

//フォームのメールアドレス入力箇所のname属性の値（name="○○"　の○○部分）
$Email = "mushousei36@gmai.com";
//---------------------------　必須設定　ここまで　------------------------------------
...
$Referer_check_domain = "ドメイン（anekkocamp.net）";
...
$require = array('お名前(漢字)','Email','お問合せ内容');
